...
namespace DB_ACT1_046_Pattaguan
{
    public partial class Form1 : Form
    {
        ...
        private void addOrDeleteRecordToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmNew_UpdateRecord frm = new frmNew_UpdateRecord();
            frm.ShowDialog();
        }

        private void deleteRecordToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmDeleteRecord frm = new frmDeleteRecord();
            frm.ShowDialog();
        }
    }
}
